...
function App() {
  return (
    <div className="App font-poppins">
      ...
      <div className="text-left grid sm:grid-cols-2 grid-cols-1 p-24 relative overflow-hidden bg-white dark:bg-stone-900">
        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700">
          ...
          <li class="mb-10 ml-6">
            <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
              <img src="./img/rapputappu.png" class='w-full h-full'></img>
            </span>
          ...
          <li class="ml-6">
            <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
              <img src="./img/fire.png" class='w-full h-full'></img>
            </span>
            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">
          ...
          <li class="ml-6">
            <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
              <img src="./img/mouji.png" class='w-full h-full'></img>
            </span>
            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">
              Flowbite Library v1.2.2
            </h3>
          ...
          <li class="ml-6">
            <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
              <img src="./img/record.png" class='w-full h-full'></img>
            </span>
